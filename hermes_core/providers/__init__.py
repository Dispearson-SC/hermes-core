...
from hermes_core.providers.base import ProviderProfile
...
def _discover_entry_point_providers() -> None:
    ...
    * **Provider targets only.** The ``hermes_agent.plugins`` group is shared
    ...
    try:
        from hermes_core.runtime.plugins import _get_disabled_plugins, _get_enabled_plugins
...
def _discover_providers() -> None:
    ...
    try:
        ...
        import hermes_core.providers as _pkg
...
_PLUGIN_COMPAT_LAZY = {
    'OMIT_TEMPERATURE': ('hermes_core.providers.base', 'OMIT_TEMPERATURE'),
}
