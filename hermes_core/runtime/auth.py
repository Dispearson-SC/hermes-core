...
from hermes_core.seams.paths import OPENROUTER_BASE_URL, secure_parent_dir
from hermes_core.agent.credential_persistence import sanitize_borrowed_credential_payload
from hermes_core.utils import atomic_replace, atomic_yaml_write, env_float, is_truthy_value  # noqa: F401  (env_float: agent.credential_pool reads auth_mod.env_float)
from hermes_core.runtime.auth_zai_kimi import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_model_picker import (  # noqa: F401  re-exported
    _prompt_model_selection, _save_model_choice)
from hermes_core.runtime.auth_device_flow import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_oauth_grants import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_nous import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_minimax import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_xai import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_codex import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_spotify import (  # noqa: F401  re-exported
    _refresh_spotify_oauth_state, get_spotify_auth_status, login_spotify_command,
    resolve_spotify_runtime_credentials)
from hermes_core.runtime.auth_qwen import (  # noqa: F401  re-exported
...
from hermes_core.runtime.auth_constants import (  # noqa: F401  re-exported
...
try:
    from hermes_core.providers import list_providers as _list_providers_for_registry
...
def get_anthropic_key() -> str:
    ...
    """
    from hermes_core.seams.config import get_env_value_prefer_dotenv
...
def _resolve_api_key_provider_secret(provider_id: str, pconfig: ProviderConfig) -> tuple[str, str]:
    ...
    if provider_id == "copilot":
        ...
        try:
            from hermes_core.runtime.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _global_auth_file_path() -> Optional[Path]:
    ...
    try:
        from hermes_core.seams.paths import get_default_hermes_root
...
def _keyless_provider_has_explicit_config(normalized: str) -> bool:
    ...
    if normalized in _VERTEX_PROVIDER_IDS:
        from hermes_core.agent.vertex_adapter import has_explicit_vertex_config
...
def _get_config_hint_for_unknown_provider(provider_name: str) -> str:
    ...
    try:
        from hermes_core.seams.config import validate_config_structure
...
def _refuse_env_adoption_if_config_corrupt() -> None:
    ...
    try:
        from hermes_core.seams.config import get_active_config_parse_failure
...
def _plugin_aliases() -> Dict[str, str]:
    ...
    try:
        from hermes_core.providers import list_providers as _lp
        for _pp in _lp():
...
def _scoped_key_env_reader() -> Callable[[str], str]:
    ...
    try:
        ...
        from hermes_core.seams.auxiliary_client import _scoped_key_env
...
def _openrouter_auto_detected(scoped_key_env: Callable[[str], str]) -> bool:
    ...
    try:
        ...
        from hermes_core.seams.credential_pool import load_pool as _load_pool
...
def resolve_provider(
    ...
    *,
    ...
    try:
        from hermes_core.agent.bedrock_adapter import has_aws_credentials
...
def _provider_is_keyless(provider_id: str) -> bool:
    ...
    try:
        from hermes_core.runtime.providers import HERMES_OVERLAYS
...
def _external_process_auth_evidence(provider_id: str) -> tuple[bool, Optional[str]]:
    ...
    try:
        from hermes_core.runtime.copilot_auth import COPILOT_ENV_VARS, validate_copilot_token
...
def _external_process_spec(
    ...
    try:
        from hermes_core.providers import get_provider_profile as _get_provider_profile
...
def _get_azure_foundry_auth_status() -> Dict[str, Any]:
    ...
    try:
        from hermes_core.seams.config import load_config, get_env_value_prefer_dotenv
        cfg = load_config()
    except Exception:
        cfg = {}
    ...
    if auth_mode == "entra_id":
        try:
            from hermes_core.agent.azure_identity_adapter import (
...
def _update_config_for_provider(
    ...
    *default_model*, when given, is written as ``model.default`` in the same step so the gateway
    ...
    from hermes_core.seams.config import clear_model_endpoint_credentials
...
_PLUGIN_COMPAT_LAZY = {
    'CODEX_OAUTH_USER_AGENT': ('hermes_core.runtime.auth_constants', 'CODEX_OAUTH_USER_AGENT'),
    'CODEX_QUOTA_PROBE_MIN_INTERVAL_SECONDS': ('hermes_core.runtime.auth_codex', 'CODEX_QUOTA_PROBE_MIN_INTERVAL_SECONDS'),
    'DEFAULT_SPOTIFY_REDIRECT_URI': ('hermes_core.runtime.auth_constants', 'DEFAULT_SPOTIFY_REDIRECT_URI'),
    'DEVICE_AUTH_POLL_INTERVAL_CAP_SECONDS': ('hermes_core.runtime.auth_constants', 'DEVICE_AUTH_POLL_INTERVAL_CAP_SECONDS'),
    'MINIMAX_OAUTH_GRANT_TYPE': ('hermes_core.runtime.auth_constants', 'MINIMAX_OAUTH_GRANT_TYPE'),
    'NOUS_INFERENCE_INVOKE_SCOPE': ('hermes_core.runtime.auth_constants', 'NOUS_INFERENCE_INVOKE_SCOPE'),
    'NOUS_SHARED_STORE_FILENAME': ('hermes_core.runtime.auth_nous', 'NOUS_SHARED_STORE_FILENAME'),
    'OAUTH_OVER_SSH_DOCS_URL': ('hermes_core.runtime.auth_constants', 'OAUTH_OVER_SSH_DOCS_URL'),
    'QWEN_OAUTH_CLIENT_ID': ('hermes_core.runtime.auth_constants', 'QWEN_OAUTH_CLIENT_ID'),
    'QWEN_OAUTH_TOKEN_URL': ('hermes_core.runtime.auth_constants', 'QWEN_OAUTH_TOKEN_URL'),
    'SINGLE_USE_OAUTH_SINGLETON_FILES': ('hermes_core.runtime.auth_oauth_grants', 'SINGLE_USE_OAUTH_SINGLETON_FILES'),
    'SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS': ('hermes_core.runtime.auth_constants', 'SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS'),
    'SPOTIFY_DASHBOARD_URL': ('hermes_core.runtime.auth_constants', 'SPOTIFY_DASHBOARD_URL'),
    'XAI_OAUTH_DEVICE_CODE_URL': ('hermes_core.runtime.auth_constants', 'XAI_OAUTH_DEVICE_CODE_URL'),
    'XAI_OAUTH_DISCOVERY_URL': ('hermes_core.runtime.auth_constants', 'XAI_OAUTH_DISCOVERY_URL'),
    'XAI_OAUTH_ISSUER': ('hermes_core.runtime.auth_constants', 'XAI_OAUTH_ISSUER'),
    'refresh_nous_oauth_pure': ('hermes_core.runtime.auth_nous', 'refresh_nous_oauth_pure'),
}
