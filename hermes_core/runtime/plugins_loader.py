...
from hermes_core.seams.paths import get_hermes_home, reset_hermes_home_override, set_hermes_home_override
from hermes_core.registration_lifecycle import replacement_coordinator
from hermes_core.runtime.plugins_discovery import ENTRY_POINTS_GROUP, _select_entry_point_group
from hermes_core.runtime.plugins_manifest import PluginManifest, manifest_key, validate_config_schema
from hermes_core.runtime.plugins_state import _plugin_settings_entry

if TYPE_CHECKING:  # pragma: no cover
    from hermes_core.runtime.plugins import LoadedPlugin

logger = logging.getLogger("hermes_core.runtime.plugins")
...
class PluginLoaderMixin:
    ...
    def _register_deferred_platform_tools(self, manifest: PluginManifest, loaded: LoadedPlugin) -> None:
        ...
        """
        from hermes_core.runtime.plugins import PluginContext, _PLUGINS_DEBUG
    ...
    def _load_plugin_scoped(self, manifest: PluginManifest) -> None:
        ...
        from hermes_core.runtime.plugins import LoadedPlugin, PluginContext, _PLUGINS_DEBUG
    ...
    def _track_tool_override_policy(self, manifest: PluginManifest, module_name: str) -> None:
        ...
        from hermes_core.runtime.plugins import PluginContext
    ...
    def _load_portable_plugin(self, manifest: PluginManifest, loaded: LoadedPlugin) -> None:
        ...
        lookup_key = manifest_key(manifest)
        try:
            from hermes_core.runtime.agent_plugins import load_agent_plugin
