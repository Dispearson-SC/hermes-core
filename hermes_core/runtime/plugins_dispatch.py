...
from hermes_core.runtime.middleware import OBSERVER_SCHEMA_VERSION
...
class PluginDispatchMixin:
    ...
    def invoke_hook(self, hook_name: str, **kwargs: Any) -> List[Any]:
        ...
        """
        from hermes_core.runtime.plugins import _resolve_hook_callback_timeout
    ...
    def _deliver_event(self, item: _QueuedPluginEvent) -> None:
        ...
        from hermes_core.runtime.plugins import resolve_plugin_command_result
        with self._event_lock:
