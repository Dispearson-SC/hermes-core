...
def _build_inspection_agent(platform: str) -> Any:
    ...
    from hermes_core.runtime.tools_config import _get_platform_tools
    from hermes_core.agent.skill_utils import parse_config_string_list
...
def _skill_md_paths_by_name() -> Dict[str, Path]:
    ...
    """
    from hermes_core.agent.skill_utils import get_all_skills_dirs, iter_skill_index_files, parse_frontmatter
...
def compute_prompt_breakdown(platform: str = "cli") -> Dict[str, Any]:
    ...
    """
    from hermes_core.agent.system_prompt import build_system_prompt, build_system_prompt_parts
