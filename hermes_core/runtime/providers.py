...
def _models_dev_info(canonical: str, allow_network: bool = True):
    ...
    try:
        from hermes_core.agent.models_dev import get_provider_info as _mdev_provider
...
def get_provider(name: str, *, allow_network: bool = True) -> Optional[ProviderDef]:
    ...
    try:
        from hermes_core.providers import get_provider_profile as _profile
...
def _lossy_alias_registry_pdef(raw: str, canonical: str) -> Optional[ProviderDef]:
    ...
    try:
        from hermes_core.runtime.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
