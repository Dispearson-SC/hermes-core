...
from hermes_core.runtime._subprocess_compat import noninteractive_git_env
...
def _bootstrap_session_db(home: str, done: threading.Event) -> None:
    ...
    try:
        from hermes_core.seams.paths import reset_hermes_home_override, set_hermes_home_override
