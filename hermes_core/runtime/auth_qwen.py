...
def _read_qwen_cli_tokens() -> Dict[str, Any]:
    from hermes_core.runtime.auth import _qwen_cli_auth_path
...
def _save_qwen_cli_tokens(tokens: Dict[str, Any]) -> Path:
    from hermes_core.runtime.auth import _qwen_cli_auth_path, _write_private_file_atomic
    auth_path = _qwen_cli_auth_path()
...
def _mark_qwen_oauth_active(creds: Dict[str, Any]) -> None:
    ...
    from hermes_core.runtime.auth import _auth_store_lock, _load_auth_store, _save_auth_store, _save_provider_state
...
def resolve_qwen_runtime_credentials(
    *, force_refresh: bool = False, refresh_if_expiring: bool = True,
    ...
    from hermes_core.runtime.auth import _qwen_cli_auth_path, _refresh_qwen_cli_tokens
...
def get_qwen_auth_status() -> Dict[str, Any]:
    from hermes_core.runtime.auth import _qwen_cli_auth_path, resolve_qwen_runtime_credentials
    auth_path = _qwen_cli_auth_path()
    try:
