...
from hermes_core.runtime.plugin_capabilities import VALID_CAPABILITY_IDS
from hermes_core.runtime.plugin_capabilities import parse_declared_capabilities as _parse_declared_capabilities
from hermes_core.runtime.plugins_manifest import (
    PluginManifest, _detect_kind_from_source, manifest_key, _resolve_module_source,
    parse_manifest_file, portable_plugin_manifest,
)
from hermes_core.runtime.relay_plugin_cutover import LEGACY_RELAY_PLUGIN_KEYS, RELAY_PLUGINS_CONFIG_ENV
...
def collect_directory_manifests() -> List[PluginManifest]:
    ...
    from hermes_core.runtime import plugins as _origin  # patched names resolve through the origin
    manifests: List[PluginManifest] = []
