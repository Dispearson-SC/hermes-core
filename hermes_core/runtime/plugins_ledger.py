...
from hermes_core.runtime.plugins_loader import _plugin_home_scope
from hermes_core.runtime.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from hermes_core.runtime.plugins import _PLUGINS_DEBUG
    ...
    def _reset_after_unload_all(self, registrations: List[PluginRegistration]) -> None:
        ...
        if preledger_tools:
            try:
                from hermes_core.tools.registry import registry as tool_registry
