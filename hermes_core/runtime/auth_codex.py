...
def _parse_retry_after_seconds(headers: Any) -> Optional[int]:
    ...
    from hermes_core.agent.retry_utils import parse_retry_after_seconds
...
def _clear_pool_entry_status(entry: Dict[str, Any]) -> None:
    ...
    from hermes_core.runtime.auth import _POOL_STATUS_FIELDS
...
def _load_auth_store_maybe_locked(lock: bool) -> Dict[str, Any]:
    ...
    from hermes_core.runtime.auth import _auth_store_lock, _load_auth_store
    if lock:
...
def _read_codex_tokens(*, _lock: bool = True) -> Dict[str, Any]:
    ...
    from hermes_core.runtime.auth import _load_provider_state, _nonempty_str
...
def _recover_codex_tokens_from_cli(reason: str) -> Optional[Dict[str, str]]:
    ...
    from hermes_core.runtime.auth import _import_codex_cli_tokens, _save_codex_tokens
...
def _codex_http_client(**kwargs: Any) -> "httpx.Client":
    ...
    with suppress(Exception):
        from hermes_core.agent.process_bootstrap import enable_happy_eyeballs_on_client
...
def refresh_codex_oauth_pure(
    ...
    from hermes_core.runtime.auth import _nonempty_str, _utc_now_z
...
def _refresh_codex_auth_tokens(tokens: Dict[str, str], timeout_seconds: float) -> Dict[str, str]:
    ...
    from hermes_core.runtime.auth import _save_codex_tokens, refresh_codex_oauth_pure
    try:
...
def _import_codex_cli_tokens() -> Optional[Dict[str, str]]:
    ...
    from hermes_core.runtime.auth import _codex_access_token_is_expiring
...
def _probe_codex_quota_restored(
    ...
    this freely.
    """
    from hermes_core.runtime.auth import _codex_quota_probe_cache, _nonempty_str
...
def _codex_pool_rate_limit_status() -> Optional[Dict[str, Any]]:
    ...
    from hermes_core.runtime.auth import _nonempty_str
    from hermes_core.seams.credential_pool import _parse_absolute_timestamp
    try:
        now = time.time()
...
def _codex_device_code_login() -> Dict[str, Any]:
    ...
    from hermes_core.runtime.auth import _utc_now_z
