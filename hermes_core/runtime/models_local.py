...
from hermes_core.runtime.urllib_security import url_origin

# Log-record parity with the origin module.
logger = logging.getLogger("hermes_core.runtime.models")
...
def _configured_ollama_base_url() -> str:
    ...
    from hermes_core.runtime.models import _get_provider_config_dict
...
def _get_ollama_base_url() -> str:
    ...
    from hermes_core.runtime.models import _get_model_config_dict
...
def probe_ollama_local_models(
    ...
    from hermes_core.runtime.models import _HERMES_USER_AGENT, _get_ollama_base_url, _urlopen_model_catalog_request
...
def _ollama_local_catalog(force_refresh: bool) -> list[str]:
    ...
    Cloud)."""
    from hermes_core.runtime.models import _get_provider_config_dict, fetch_api_models
    if force_refresh:
...
def _lmstudio_fetch_raw_models(
    ...
    try:
        ...
        if exc.code in {401, 403}:
            from hermes_core.runtime.auth import AuthError
            raise AuthError(
...
def _load_ollama_cloud_cache(*, ignore_ttl: bool = False) -> Optional[dict]:
    ...
    from hermes_core.runtime.models import _read_json_cache
...
def _save_ollama_cloud_cache(models: list[str]) -> None:
    ...
    from hermes_core.runtime.models import _write_json_cache
...
def fetch_ollama_cloud_models(
    ...
    *,
    ...
    Never None."""
    from hermes_core.runtime.models import fetch_api_models
