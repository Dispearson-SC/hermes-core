...
from hermes_core.runtime import auth as auth_mod
from hermes_core.seams.credential_pool import (  # custom_provider_pool_key_candidates is read via origin by runtime_provider_custom
    CredentialPool, PooledCredential, credential_pool_matches_provider, custom_provider_pool_key_candidates,  # noqa: F401
    load_pool,
)
from hermes_core.agent.secret_scope import get_secret as _get_secret
from hermes_core.runtime.auth import (  # resolve_external_process_provider_credentials is read via origin by runtime_provider_backends
...
from hermes_core.seams import config as _config_mod
from hermes_core.runtime import models as _models  # attribute access keeps ``hermes_cli.models.<name>`` patches effective
from hermes_core.seams.paths import OPENROUTER_BASE_URL
from hermes_core.runtime.providers import determine_api_mode, is_official_openai_host, nous_api_mode
from hermes_core.utils import base_url_host_matches, base_url_hostname, env_int
...
from hermes_core.runtime.runtime_provider_custom import (  # noqa: E402,F401
...
from hermes_core.runtime.runtime_provider_backends import (  # noqa: E402,F401
...
_PLUGIN_COMPAT_LAZY = {
    'custom_provider_aliases': ('hermes_core.runtime.providers', 'custom_provider_aliases'),
    'custom_provider_slug': ('hermes_core.runtime.providers', 'custom_provider_slug'),
}
