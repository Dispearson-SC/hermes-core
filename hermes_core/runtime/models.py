...
from hermes_core.runtime.urllib_security import open_credentialed_url
from hermes_core.runtime.models_catalog_static import (
    CANONICAL_PROVIDERS,
    OPENROUTER_MODELS,
...
from hermes_core.runtime.models_reasoning_caps import (
    _OPENROUTER_CATALOG_URL,
    _seed_reasoning_caps)
from hermes_core.runtime.models_local import (
...
def _write_json_cache(path: Path, data: Any, **dump_kwargs: Any) -> None:
    ...
    from hermes_core.utils import atomic_json_write
...
def _custom_provider_ssl_context(base_url: str):
    ...
    if not base_url:
        return None
    try:
        from hermes_core.seams.config import get_custom_provider_tls_settings
...
def _pricing_profile_key() -> str:
    ...
    from hermes_core.seams.paths import hermes_home_key
...
def check_nous_free_tier(*, force_fresh: bool = False, cached_only: bool = False) -> bool:
    ...
    if cached_only:
        return False
    try:
        from hermes_core.runtime.nous_account import get_nous_portal_account_info
...
def _resolve_nous_portal_url() -> str:
    ...
    try:
        from hermes_core.runtime.auth import DEFAULT_NOUS_PORTAL_URL, get_provider_auth_state
...
def get_preferred_silent_default_model(provider: str = "openrouter") -> str:
    ...
    try:
        from hermes_core.runtime.model_catalog import get_default_model_from_cache
...
from hermes_core.agent.reasoning_effort import clamp_effort as _clamp_effort
...
def fetch_openrouter_models(
    ...
    try:
        from hermes_core.runtime.model_catalog import get_curated_openrouter_models
...
def get_curated_nous_model_ids() -> list[str]:
    ...
    try:
        from hermes_core.runtime.model_catalog import get_curated_nous_models
...
def fetch_ai_gateway_models(
    ...
    from hermes_core.seams.paths import AI_GATEWAY_BASE_URL
...
def _configured_custom_provider_ids() -> set[str]:
    ...
    try:
        ...
        from hermes_core.runtime.providers import custom_provider_slug
...
def _provider_has_credentials(pid: str) -> bool:
    try:
        from hermes_core.runtime.auth import get_auth_status, has_usable_secret
...
def _resolve_static_model_alias(
    ...
    try:
        from hermes_core.runtime.model_switch import MODEL_ALIASES
    except Exception:
        return None
...
def model_supports_fast_mode(model_id: Optional[str]) -> bool:
    ...
    from hermes_core.agent.model_metadata import is_grok_46_family
...
def _first_exchangeable_copilot_token(raw_tokens) -> str:
    ...
    from hermes_core.runtime.copilot_auth import exchange_copilot_token, validate_copilot_token
...
def _resolve_copilot_catalog_api_key() -> str:
    ...
    def _pool_token() -> str:
        from hermes_core.runtime.auth import read_credential_pool
...
def _model_dedup_key(model_id: str) -> str:
    ...
    try:
        from hermes_core.runtime.model_search import model_alias_canonical
...
def _merge_with_models_dev(provider: str, curated: list[str]) -> list[str]:
    ...
    try:
        from hermes_core.agent.models_dev import list_agentic_models
...
def _codex_catalog(normalized: str, force_refresh: bool) -> list[str]:
    from hermes_core.runtime.codex_models import get_codex_model_ids
    ...
    try:
        from hermes_core.runtime.auth import resolve_codex_runtime_credentials
...
def _nous_catalog(normalized: str, force_refresh: bool) -> Optional[list[str]]:
    try:
        from hermes_core.runtime.auth import fetch_nous_models, resolve_nous_runtime_credentials
...
def _api_key_credentials(normalized: str) -> tuple[str, str]:
    ...
    try:
        from hermes_core.runtime.auth import resolve_api_key_provider_credentials
...
def _openai_catalog(normalized: str, force_refresh: bool) -> Optional[list[str]]:
    ...
    from hermes_core.runtime.providers import is_official_openai_host
...
def _bedrock_catalog(normalized: str, force_refresh: bool) -> Optional[list[str]]:
    ...
    try:
        from hermes_core.agent.bedrock_adapter import bedrock_model_ids_or_none
...
def _resolve_anthropic_pool_catalog_credentials() -> tuple[str, str]:
    ...
    try:
        from hermes_core.seams.credential_pool import AUTH_TYPE_API_KEY
        from hermes_core.runtime.auth import read_credential_pool
...
def _fetch_anthropic_models(
    ...
    try:
        from hermes_core.agent.anthropic_credentials import resolve_anthropic_token, _is_oauth_token
    except ImportError:
        return None
    ...
    if is_oauth:
        ...
        from hermes_core.agent.anthropic_adapter import _COMMON_BETAS, _OAUTH_ONLY_BETAS, _CONTEXT_1M_BETA
...
def copilot_default_headers(*, is_agent_turn: bool = True) -> dict[str, str]:
    ...
    try:
        from hermes_core.runtime.copilot_auth import copilot_request_headers
...
def opencode_zen_free_headers() -> dict:
    ...
    try:
        from hermes_core.runtime import __version__ as _v
    except Exception:
        _v = "0"
    return {
        "Authorization": "",
...
def probe_api_models(
    ...
    if isinstance(request_headers, dict):
        ...
        from hermes_core.seams.config import normalize_extra_headers
...
_PLUGIN_COMPAT_LAZY = {
    'LMStudioLoadResult': ('hermes_core.runtime.models_local', 'LMStudioLoadResult'),
    'PROVIDER_GROUPS': ('hermes_core.runtime.models_catalog_static', 'PROVIDER_GROUPS'),
    'ProviderEntry': ('hermes_core.runtime.models_catalog_static', 'ProviderEntry'),
    'atomic_json_write': ('utils', 'atomic_json_write'),
    'base_url_host_matches': ('utils', 'base_url_host_matches'),
    'compute_sale_discount': ('hermes_core.runtime.models_pricing', 'compute_sale_discount'),
    'ensure_lmstudio_model_loaded': ('hermes_core.runtime.models_local', 'ensure_lmstudio_model_loaded'),
    'fetch_ai_gateway_pricing': ('hermes_core.runtime.models_pricing', 'fetch_ai_gateway_pricing'),
    'fetch_lmstudio_models': ('hermes_core.runtime.models_local', 'fetch_lmstudio_models'),
    'fetch_models_with_pricing': ('hermes_core.runtime.models_pricing', 'fetch_models_with_pricing'),
    'fetch_ollama_local_models': ('hermes_core.runtime.models_local', 'fetch_ollama_local_models'),
    'get_cached_nous_inference_base_url': ('hermes_core.runtime.models_pricing', 'get_cached_nous_inference_base_url'),
    'get_pricing_for_provider': ('hermes_core.runtime.models_pricing', 'get_pricing_for_provider'),
    'group_providers': ('hermes_core.runtime.models_catalog_static', 'group_providers'),
    'lmstudio_model_reasoning_options': ('hermes_core.runtime.models_local', 'lmstudio_model_reasoning_options'),
    'nous_catalog_url': ('hermes_core.runtime.models_reasoning_caps', 'nous_catalog_url'),
    'nous_model_reasoning_capabilities': ('hermes_core.runtime.models_reasoning_caps', 'nous_model_reasoning_capabilities'),
    'nous_policy_allowed_ids': ('hermes_core.runtime.models_pricing', 'nous_policy_allowed_ids'),
    'ollama_model_supports_thinking': ('hermes_core.runtime.models_local', 'ollama_model_supports_thinking'),
    'openrouter_model_reasoning_capabilities': ('hermes_core.runtime.models_reasoning_caps', 'openrouter_model_reasoning_capabilities'),
    'parse_openrouter_reasoning_capabilities': ('hermes_core.runtime.models_reasoning_caps', 'parse_openrouter_reasoning_capabilities'),
    'peek_cached_pricing': ('hermes_core.runtime.models_pricing', 'peek_cached_pricing'),
    'pricing_cache_scope': ('hermes_core.runtime.models_pricing', 'pricing_cache_scope'),
    'probe_lmstudio_models': ('hermes_core.runtime.models_local', 'probe_lmstudio_models'),
    'probe_ollama_local_models': ('hermes_core.runtime.models_local', 'probe_ollama_local_models'),
    'provider_group_for_slug': ('hermes_core.runtime.models_catalog_static', 'provider_group_for_slug'),
    'refresh_reasoning_caps_async': ('hermes_core.runtime.models_reasoning_caps', 'refresh_reasoning_caps_async'),
    'restrict_to_nous_policy': ('hermes_core.runtime.models_pricing', 'restrict_to_nous_policy'),
    'should_use_ollama_native_catalog': ('hermes_core.runtime.models_local', 'should_use_ollama_native_catalog'),
    'url_origin': ('hermes_core.runtime.urllib_security', 'url_origin'),
    'validate_requested_model': ('hermes_cli.models_validate', 'validate_requested_model'),
    'warm_nous_reasoning_caps_async': ('hermes_core.runtime.models_reasoning_caps', 'warm_nous_reasoning_caps_async'),
    'warm_openrouter_reasoning_caps_async': ('hermes_core.runtime.models_reasoning_caps', 'warm_openrouter_reasoning_caps_async'),
}
