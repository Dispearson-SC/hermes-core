...
def perform_api_call(
    ...
    from hermes_core.runtime.middleware import run_llm_execution_middleware
...
def handle_api_interrupt(
    ...
    from hermes_core.agent.conversation_loop import INTERRUPT_WAITING_FOR_MODEL_PREFIX
...
def nous_rate_limit_guard(
    ...
    if agent.provider == "nous":
        try:
            from hermes_core.agent.nous_rate_guard import (
