...
from hermes_core.agent.repetition_guard import is_repetition_dominated
from hermes_core.agent.turn_api_call import stop_thinking_spinner
from hermes_core.agent.turn_retry_state import TurnRetryState
from hermes_core.seams.paths import PARTIAL_STREAM_STUB_ID
...
def _continue_text(st: _Trunc, _retry: TurnRetryState, assistant_message: Any) -> TruncationVerdict:
    ...
    from hermes_core.agent.conversation_loop import _get_continuation_prompt, _join_truncated_parts
...
def continue_codex_incomplete(
    ...
    from hermes_core.agent.conversation_loop import _CODEX_INCOMPLETE_NUDGE
        ...
        if (
            ...
            for _key in _CODEX_REPLAY_KEYS:
                ...
                if _key == "codex_reasoning_items":
                    from hermes_core.agent.native_compaction import merge_interim_reasoning_items
