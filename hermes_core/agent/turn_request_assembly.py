...
from hermes_core.agent.message_sanitization import _sanitize_messages_surrogates
from hermes_core.agent.model_metadata import anchored_context_tokens
from hermes_core.agent.prompt_caching import build_prompt_cache_plan, effective_cache_ttl
from hermes_core.agent.turn_context import build_api_messages
...
def _append_moa_context(agent: Any, api_messages: Any, moa_config: Any, original_user_message: Any) -> None:
    ...
    try:
        from hermes_core.agent.message_content import flatten_message_text as _flatten_mt
        from hermes_core.agent.moa_loop import _preset_temperature, aggregate_moa_context
...
def assemble_api_request(
    ...
    try:
        from hermes_core.agent.agent_runtime_helpers import consume_pending_sanitizer_heal_notice
    ...
    from hermes_core.agent.turn_context import _agent_stale_thinking_on_wire
