...
from hermes_core.runtime._subprocess_compat import IS_WINDOWS, kill_process_tree, split_command_line, windows_hide_flags
...
from hermes_core.utils import atomic_replace
...
def register_from_config(cfg: Optional[Dict[str, Any]], *, accept_hooks: bool = False) -> List[ShellHookSpec]:
    ...
    if not specs:
        return []
    from hermes_core.runtime.plugins import get_plugin_manager  # lazy: avoids import cycle
...
def _parse_hooks_block(hooks_cfg: Any) -> List[ShellHookSpec]:
    ...
    from hermes_core.runtime.plugins import SHELL_UNSUPPORTED_HOOKS, VALID_HOOKS
