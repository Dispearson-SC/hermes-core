...
from hermes_core.agent.turn_empty_response import recover_empty_response
from hermes_core.agent.turn_stop_gates import apply_stop_gates
...
def finish_text_response(
    ...
    from hermes_core.agent.agent_runtime_helpers import (
