...
from hermes_core.agent.memory_provider import MemoryProvider, PRE_COMPRESS_CHECKPOINT_API_VERSION
from hermes_core.agent.skill_commands import extract_user_instruction_from_skill_message
...
def memory_provider_tools_enabled(enabled_toolsets: Optional[List[str]], disabled_toolsets: Optional[List[str]] = None,
    ...
    if "memory" in enabled_toolsets:
        return True
    try:
        from hermes_core.toolsets import resolve_toolset
...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        from hermes_core.toolsets import _HERMES_CORE_TOOLS
