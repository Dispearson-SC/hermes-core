...
from hermes_core.utils import normalize_proxy_env_vars

from hermes_core.agent.anthropic_credentials import _is_oauth_token
from hermes_core.agent.anthropic_endpoints import (
...
from hermes_core.agent.anthropic_message_convert import (
...
def _get_anthropic_sdk():
    ...
    if _anthropic_sdk is ...:
        with suppress(Exception):  # ImportError or FeatureUnavailable — fall through to the import below
            from hermes_core.tools.lazy_deps import ensure as _lazy_ensure
...
def _build_anthropic_client_with_bearer_hook(
    ...
    from hermes_core.agent.azure_identity_adapter import build_bearer_http_client
...
_PLUGIN_COMPAT_LAZY = {
    'CredentialPersistError': ('hermes_core.agent.anthropic_credentials', 'CredentialPersistError'),
    'base_url_host_matches': ('utils', 'base_url_host_matches'),
    'base_url_hostname': ('utils', 'base_url_hostname'),
    'claude_code_credentials_path': ('hermes_core.agent.anthropic_credentials', 'claude_code_credentials_path'),
    'get_hermes_home': ('hermes_constants', 'get_hermes_home'),
    'is_claude_code_token_valid': ('hermes_core.agent.anthropic_credentials', 'is_claude_code_token_valid'),
    'is_rotation_consumed_uncommitted': ('hermes_core.agent.anthropic_credentials', 'is_rotation_consumed_uncommitted'),
    'mark_rotation_consumed_uncommitted': ('hermes_core.agent.anthropic_credentials', 'mark_rotation_consumed_uncommitted'),
    'read_claude_code_credentials': ('hermes_core.agent.anthropic_credentials', 'read_claude_code_credentials'),
    'read_hermes_oauth_credentials': ('hermes_core.agent.anthropic_credentials', 'read_hermes_oauth_credentials'),
    'refresh_anthropic_oauth_pure': ('hermes_core.agent.anthropic_credentials', 'refresh_anthropic_oauth_pure'),
    'resolve_anthropic_token': ('hermes_core.agent.anthropic_credentials', 'resolve_anthropic_token'),
    'run_hermes_oauth_login_pure': ('hermes_core.agent.anthropic_credentials', 'run_hermes_oauth_login_pure'),
    'run_oauth_setup_token': ('hermes_core.agent.anthropic_credentials', 'run_oauth_setup_token'),
}
