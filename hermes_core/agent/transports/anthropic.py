...
def _unprefix_oauth_tool_name(name: str) -> str:
    ...
    from hermes_core.agent.anthropic_adapter import _OAUTH_TOOL_NAME_REVERSE_ALIASES
    from hermes_core.tools.registry import registry as _tool_registry
...
class AnthropicTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        from hermes_core.agent.anthropic_message_convert import convert_messages_to_anthropic
        return convert_messages_to_anthropic(messages, base_url=kwargs.get("base_url"))

    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        """Convert OpenAI tool schemas to Anthropic input_schema format."""
        from hermes_core.agent.anthropic_message_convert import convert_tools_to_anthropic
    ...
    def build_kwargs(
        ...
        from hermes_core.agent.anthropic_adapter import build_anthropic_kwargs
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        import json
        from hermes_core.agent.anthropic_message_convert import _sanitize_replay_block, _to_plain_data
