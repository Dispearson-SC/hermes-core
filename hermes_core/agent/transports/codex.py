...
from hermes_core.agent.reasoning_effort import (
...
from hermes_core.agent.transports.types import NormalizedResponse, ToolCall
...
def _is_opencode_responses_backend(params: dict[str, Any]) -> bool:
    ...
    try:
        ...
        pass
    try:
        from hermes_core.utils import base_url_hostname
...
def _xai_prefers_native_web_search() -> bool:
    ...
    """
    try:
        from hermes_core.agent.web_search_registry import get_active_search_provider

        provider = get_active_search_provider()
        if provider is not None:
            return getattr(provider, "name", None) == "xai"

        from hermes_core.tools.web_tools import _get_search_backend
...
def _profile_declared_efforts(provider: Any, model: Optional[str], base_url: Any = None) -> Optional[tuple]:
    ...
    try:
        ...
        if declared is None and base_url:
            from hermes_core.agent.model_metadata import _infer_provider_from_url
...
def _is_post_tool_replay(messages: Optional[list[dict[str, Any]]]) -> bool:
    ...
    """
    from hermes_core.agent.codex_responses_adapter import _canonical_call_id_from_fc, _split_responses_tool_id
...
def _reasoning_fields(
    ...
    if enabled and is_xai_responses:
        from hermes_core.agent.model_metadata import grok_supports_reasoning_effort
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def _resolve_issuer_kind(self, params: dict[str, Any]) -> str:
        ...
        from hermes_core.agent.codex_responses_adapter import _classify_responses_issuer
    ...
    def convert_messages(self, messages: list[dict[str, Any]], **kwargs) -> Any:
        ...
        from hermes_core.agent.codex_responses_adapter import _chat_messages_to_responses_input
    ...
    def convert_tools(self, tools: Optional[list[dict[str, Any]]]) -> Any:
        ...
        from hermes_core.agent.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        from hermes_core.agent.model_metadata import strip_codex_context_variant_suffix as _strip_ctx_variant
        kwargs = {
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        from hermes_core.agent.codex_responses_adapter import _normalize_codex_response
    ...
    def preflight_kwargs(
        ...
        """
        from hermes_core.agent.codex_responses_adapter import _preflight_codex_api_kwargs
...
from hermes_core.agent.transports import register_transport  # noqa: E402
