...
_REGISTRY = _Registry()
from hermes_core.tools.daemon_pool import DaemonThreadPoolExecutor as _DaemonExecutor  # daemon: a wedged child never blocks exit
...
class SubagentLifecycleService:
    ...
    def launch(self, request: SubagentLaunchRequest) -> SubagentHandle:
        ...
        from hermes_core.tools.delegate_tool import _build_child_preserving_parent_tools, DEFAULT_MAX_ITERATIONS
    ...
    def _run(self, record: _Record, goal: str, parent: Any) -> None:
        ...
        try:
            from hermes_core.tools.delegate_tool import _run_child_lifecycle
    ...
    def _validate_request(request: SubagentLaunchRequest, parent: Any) -> None:
        ...
        if not request.allowed_toolsets:
            return
        from hermes_core.toolsets import TOOLSETS
