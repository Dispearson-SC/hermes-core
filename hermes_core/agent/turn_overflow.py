...
from hermes_core.agent.message_sanitization import serialized_messages_bytes
...
class _Recovery(OverflowVerdict):
    ...
    def compress(self, request_tokens: int, *, fail_on_timeout: bool = False) -> Optional[OverflowVerdict]:
        ...
        from hermes_core.agent.conversation_loop import _COMPRESSION_TIMEOUT_FINAL_RESPONSE, _compression_deferred_result
...
def _adopt_provider_context_limit(st: _Recovery, error_msg: str, old_ctx: int) -> Optional[int]:
    ...
    from hermes_core.agent.model_metadata import save_context_length
