...
from hermes_core.agent.message_metadata import stamp_message_timestamp
from hermes_core.agent.tool_result_classification import (
    FILE_MUTATING_TOOL_NAMES as _FILE_MUTATING_TOOLS,
)
from hermes_core.tools.threat_patterns import scan_for_threats
...
def _is_mcp_tool_parallel_safe(tool_name: str) -> bool:
    ...
    try:
        from hermes_core.tools.mcp_tool_discovery import is_mcp_tool_parallel_safe
...
def _peel_bridge_call(tool_name: str, function_args: dict) -> tuple[str, dict]:
    ...
    try:
        from hermes_core.tools.tool_search import TOOL_CALL_NAME, resolve_underlying_call
