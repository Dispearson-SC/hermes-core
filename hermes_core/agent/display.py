...
from hermes_core.utils import safe_json_loads
from hermes_core.agent.redact import redact_sensitive_text
from hermes_core.agent.tool_result_classification import file_mutation_result_landed
...
def _get_skin():
    ...
    try:
        from hermes_core.runtime.skin_engine import get_active_skin
...
def _resolve_skill_manage_paths(args: dict) -> list[Path]:
    ...
    if not action or not name:
        return []
    from hermes_core.tools.skill_manager_tool import _find_skill, _resolve_skill_dir
