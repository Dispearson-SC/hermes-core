...
from hermes_core.agent.message_sanitization import deterministic_call_id
...
def _chat_messages_to_responses_input(
    ...
    if not native_compaction_eligible:
        return items
    from hermes_core.agent.native_compaction import prune_pre_checkpoint_items
...
def _preflight_codex_api_kwargs(
    ...
    if is_xai_model and normalized.get("tools"):
        try:
            from hermes_core.tools.schema_sanitizer import strip_slash_enum
