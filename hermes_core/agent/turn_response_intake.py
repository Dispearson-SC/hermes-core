...
from hermes_core.agent.provider_projection import splice_provider_projection
from hermes_core.agent.trajectory import has_incomplete_scratchpad
from hermes_core.agent.turn_truncation import continue_codex_incomplete, normalize_response_for_agent, partial_result
...
def _fire_post_api_request_hook(
    ...
    from hermes_core.agent.conversation_loop import _moa_reference_metrics_for_hook

    try:
        from hermes_core.runtime.lifecycle import has_hook, invoke_hook as _invoke_hook
