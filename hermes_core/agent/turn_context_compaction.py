...
logger = logging.getLogger("hermes_core.agent.turn_context")
...
def _reanchor(agent: Any, messages: List[Any], user_message: Any) -> int:
    ...
    from hermes_core.agent.turn_context import reanchor_current_turn_user_idx
...
def _idle_compaction(
    ...
    from hermes_core.agent import turn_context as _tc
...
def _preflight_compression(
    ...
    if _should_compress_now:
        ...
        try:
            from hermes_core.agent.conversation_loop import _maybe_grow_local_window
