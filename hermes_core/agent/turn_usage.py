...
from hermes_core.agent.model_metadata import capture_usage_anchor
from hermes_core.agent.usage_pricing import estimate_usage_cost, normalize_usage
...
def _loop_mod():
    ...
    import hermes_core.agent.conversation_loop as _cl
