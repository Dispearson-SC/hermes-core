...
from hermes_core.agent.secret_sources.base import ErrorKind, FetchResult, SecretSource, coerce_float, source_child_env
...
_PLUGIN_COMPAT_LAZY = {
    'get_source_environment': ('hermes_core.agent.secret_sources.base', 'get_source_environment'),
}
