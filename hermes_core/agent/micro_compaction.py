...
from hermes_core.agent.model_metadata import estimate_messages_tokens_rough, estimate_tokens_rough

# Log name parity with the origin module.
logger = logging.getLogger("hermes_core.agent.context_compressor")
...
def _cc():
    ...
    from hermes_core.agent import context_compressor
...
class MicroCompactionMixin:
    ...
    def _micro_summarize_one(self, exchange_text: str) -> Optional[str]:
        ...
        from hermes_core.seams.auxiliary_client import aux_interrupt_protection, call_llm
