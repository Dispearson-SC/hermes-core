...
from hermes_core.agent.memory_manager import sanitize_context
from hermes_core.agent.redact import redact_sensitive_text
from hermes_core.agent.tool_dispatch_helpers import _is_multimodal_tool_result, _multimodal_text_summary
from hermes_core.agent.trajectory import convert_scratchpad_to_think, save_trajectory as _save_trajectory_to_file
from hermes_core.agent.transcript_repair import sync_flushed_message_markers
...
def _db_flush_failed(agent, e: Exception, batch_rows: List[Dict[str, Any]], adoption_budget: int) -> bool:
    ...
    from hermes_core.seams.session_state import StateDbCorruptError, StateDbReplacedError, classify_persistence_error, divert_session_transcript_jsonl
    from hermes_core.seams.session_state import CompressionSessionClosedError
...
class SessionPersistenceMixin:
    ...
    _repair_message_sequence = _forward("hermes_core.agent.agent_runtime_helpers", "repair_message_sequence")
    ...
    _format_tools_for_system_message = _forward("hermes_core.agent.system_prompt", "format_tools_for_system_message")
    _convert_to_trajectory_format = _forward("hermes_core.agent.agent_runtime_helpers", "convert_to_trajectory_format")
    ...
    _extract_api_error_context = _forward_static("hermes_core.agent.agent_runtime_helpers", "extract_api_error_context")
    _dump_api_request_debug = _forward("hermes_core.agent.agent_runtime_helpers", "dump_api_request_debug")
