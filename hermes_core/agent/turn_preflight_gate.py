...
from hermes_core.agent.turn_context import _compression_warrants_another_preflight_pass
from hermes_core.agent.turn_preflight import PreflightGateVerdict, run_preflight_compression
...
def run_preflight_gate(
    ...
    from hermes_core.agent.conversation_loop import _ollama_context_limit_error
