...
class StreamDeliveryMixin:
    ...
    def _enqueue_stream_hook(self, event: str, *, label: str | None = None, **fields: Any) -> None:
        ...
        try:
            from hermes_core.agent.plugin_stream_hooks import enqueue_plugin_stream_hook
    ...
    def _fire_reasoning_delta(self, text: str) -> None:
        ...
        try:
            from hermes_core.agent.plugin_stream_hooks import stream_reasoning_deltas_enabled
    ...
    def _has_stream_consumers(self) -> bool:
        ...
        try:
            from hermes_core.agent.plugin_stream_hooks import has_stream_observer_hooks
