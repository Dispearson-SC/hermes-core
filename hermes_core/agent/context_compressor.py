...
from hermes_core.agent.context_engine import ContextEngine, sanitize_memory_context
from hermes_core.agent.error_classifier import FailoverReason, classify_api_error
from hermes_core.agent.micro_compaction import MicroCompactionMixin
...
def _is_summary_access_or_quota_error(exc: Exception) -> bool:
    ...
    try:
        ...
        from hermes_core.agent.secret_scope import UnscopedSecretError
...
def _salvage_reduce_todo_snapshot(out: List[Dict[str, Any]]) -> None:
    ...
    from hermes_core.agent.conversation_compression import _PRUNED_SKILL_RELOAD_NOTICE_HEADER
...
def _today_for_prompt() -> str:
    ...
    try:
        ...
        from hermes_core.hermes_time import now as _hermes_now
...
class ContextCompressor(MicroCompactionMixin, ContextEngine):
    ...
    def _serialize_for_summary(self, turns: List[Dict[str, Any]]) -> str:
        ...
        from hermes_core.agent.agent_runtime_helpers import strip_think_blocks
        parts = []
        for msg in turns:
...
Write only the summary body. Do not include any preamble or prefix."""
    ...
    def _latest_user_task_snapshot(cls, messages: List[Dict[str, Any]]) -> Optional[str]:
        ...
        from hermes_core.agent.conversation_compression import _is_real_user_message
        for msg in reversed(messages):
    ...
    def _tool_call_id_variants(tc) -> set:
        ...
        """
        from hermes_core.agent.message_sanitization import tool_call_id_variants
    ...
    def _sanitize_tool_pairs(self, messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        from hermes_core.agent.agent_runtime_helpers import _classify_tool_call_orphans
...
_PLUGIN_COMPAT_LAZY = {
    'tool_result_id_variants': ('hermes_core.agent.message_sanitization', 'tool_result_id_variants'),
}
