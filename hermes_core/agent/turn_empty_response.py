...
from hermes_core.agent import empty_response_guard as _empty_guard
from hermes_core.agent.message_metadata import append_message
from hermes_core.agent.turn_recovery import interruptible_backoff_sleep
...
def recover_empty_response(
    ...
    from hermes_core.agent.conversation_loop import _EMPTY_TOOL_RESPONSE_NUDGE, _sync_failover_system_message
