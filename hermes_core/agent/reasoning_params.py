...
from hermes_core.agent.message_sanitization import matches_reasoning_echo_family
...
class ReasoningParamsMixin:
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if base_url_host_matches(url, "models.github.ai") or base_url_host_matches(url, "githubcopilot.com"):
            try:
                from hermes_core.runtime.models import github_model_reasoning_efforts
        ...
        try:
            from hermes_core.runtime.models_reasoning_caps import openrouter_model_reasoning_capabilities, warm_openrouter_reasoning_caps_async
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        try:
            from hermes_core.runtime.models_local import lmstudio_model_reasoning_options
        except Exception:
            return []
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from hermes_core.runtime.models_local import ollama_model_supports_thinking
        except Exception:
            return False
    ...
    def _resolve_lmstudio_summary_reasoning_effort(self) -> Optional[str]:
        ...
        from hermes_core.agent.lmstudio_reasoning import resolve_lmstudio_effort
    ...
    _build_assistant_message = _forward("hermes_core.agent.chat_completion_helpers", "build_assistant_message")
    ...
    _copy_reasoning_content_for_api = _forward("hermes_core.agent.agent_runtime_helpers", "copy_reasoning_content_for_api")

    _reapply_reasoning_echo_for_provider = _forward("hermes_core.agent.agent_runtime_helpers", "reapply_reasoning_echo_for_provider")
    ...
    def _sanitize_tool_calls_for_strict_api(api_msg: dict, model: "str | None" = None) -> dict:
        ...
        if not isinstance(tool_calls, list):
            return api_msg
        from hermes_core.agent.transports.chat_completions import _model_consumes_thought_signature
    ...
    _sanitize_tool_call_arguments = _forward_static("hermes_core.agent.agent_runtime_helpers", "sanitize_tool_call_arguments")
