...
def _report_compression_timeout(
    ...
    from hermes_core.agent.conversation_compression import mark_context_compression_timed_out
...
def _sync_persisted_markers(target_messages, source_messages) -> None:
    ...
    from hermes_core.agent.conversation_compression import _stamp_scoped_twins
...
def _run_under_progress_timeout(
    ...
    from hermes_core.agent.conversation_compression import CompressionCommitFence, run_compress_context_with_progress_timeout
...
class CompressionFacadeMixin:
    ...
    def _compress_context(
        ...
        from hermes_core.agent.conversation_compression import (
