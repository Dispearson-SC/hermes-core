...
from hermes_core.agent.lazy_forward import forward_static as _forward_static
from hermes_core.agent.tool_dispatch_helpers import _is_multimodal_tool_result, _multimodal_text_summary
from hermes_core.utils import base_url_host_matches, base_url_hostname
...
class VisionMessagePrepMixin:
    ...
    def _describe_image_for_anthropic_fallback(self, image_url: str, role: str) -> str:
        ...
        try:
            from hermes_core.tools.vision_tools import vision_analyze_tool
    ...
    def _model_supports_vision(self) -> bool:
        ...
        try:
            ...
            from hermes_core.agent.image_routing import _lookup_supports_vision
    ...
    def _get_transport(self, api_mode: str = None):
        ...
        if cache.get(mode) is None:
            from hermes_core.agent.transports import get_transport
    ...
    _try_shrink_image_parts_in_messages = _forward_static("hermes_core.agent.conversation_compression", "try_shrink_image_parts_in_messages")
