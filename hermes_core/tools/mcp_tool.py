...
from hermes_core.tools.mcp_tool_common import _DEFAULT_TOOL_TIMEOUT, mcp_field
from hermes_core.tools.mcp_tool_config import _get_mcp_stderr_log, _npx_cached_bin
from hermes_core.tools.mcp_tool_sampling import ElicitationHandler, SamplingHandler
from hermes_core.tools.mcp_tool_transport import MCPServerTransportMixin
from hermes_core.tools.mcp_tool_server_run import MCPServerRunMixin
from hermes_core.tools.mcp_tool_health import MCPServerHealthMixin
...
async def _preflight_stdio_command(server_name: str, command: str, args: list) -> tuple[str, list]:
    ...
    from hermes_core.tools.osv_check import check_package_for_malware
    try:
...
def _mcp_registry_scope() -> Optional[str]:
    ...
    from hermes_core.agent.secret_scope import is_multiplex_active
...
_PLUGIN_COMPAT_LAZY = {
    'InvalidMcpUrlError': ('hermes_core.tools.mcp_tool_errors', 'InvalidMcpUrlError'),
    'MCP_TOOL_NAME_PREFIX': ('hermes_core.tools.mcp_tool_schema', 'MCP_TOOL_NAME_PREFIX'),
    'NonMcpEndpointError': ('hermes_core.tools.mcp_tool_errors', 'NonMcpEndpointError'),
    'discover_mcp_tools': ('hermes_core.tools.mcp_tool_discovery', 'discover_mcp_tools'),
    'get_mcp_status': ('hermes_core.tools.mcp_tool_discovery', 'get_mcp_status'),
    'get_registered_mcp_server_names': ('hermes_core.tools.mcp_tool_discovery', 'get_registered_mcp_server_names'),
    'has_registered_mcp_tools': ('hermes_core.tools.mcp_tool_discovery', 'has_registered_mcp_tools'),
    'is_mcp_tool_parallel_safe': ('hermes_core.tools.mcp_tool_discovery', 'is_mcp_tool_parallel_safe'),
    'matches_name_filter': ('hermes_core.tools.mcp_tool_schema', 'matches_name_filter'),
    'mcp_prefixed_tool_name': ('hermes_core.tools.mcp_tool_schema', 'mcp_prefixed_tool_name'),
    'persist_agent_tool_names': ('tools.mcp_tool_agent', 'persist_agent_tool_names'),
    'probe_mcp_server_tools': ('hermes_core.tools.mcp_tool_discovery', 'probe_mcp_server_tools'),
    'reconnect_mcp_server': ('hermes_core.tools.mcp_tool_loop', 'reconnect_mcp_server'),
    'refresh_agent_mcp_tools': ('tools.mcp_tool_agent', 'refresh_agent_mcp_tools'),
    'register_mcp_servers': ('hermes_core.tools.mcp_tool_discovery', 'register_mcp_servers'),
    ...
    'sanitize_mcp_name_component': ('hermes_core.tools.mcp_tool_schema', 'sanitize_mcp_name_component'),
    'shutdown_mcp_servers': ('hermes_core.tools.mcp_tool_lifecycle', 'shutdown_mcp_servers'),
    'strip_unicode_tags': ('hermes_core.tools.ansi_strip', 'strip_unicode_tags'),
    'tool_error': ('hermes_core.tools.registry', 'tool_error'),
}
