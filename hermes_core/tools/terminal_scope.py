...
def build_profile_terminal_scope(hermes_home: "Any") -> Dict[str, str]:
    ...
    """
    from hermes_core.seams.config import TERMINAL_CONFIG_ENV_MAP, _terminal_env_value
    from hermes_core.runtime.config_defaults import DEFAULT_CONFIG
    ...
    if env_path.exists():
        ...
        from hermes_core.agent.secret_scope import load_env_file
    ...
    if config_exists:
        from hermes_core.seams.config import fast_safe_load
