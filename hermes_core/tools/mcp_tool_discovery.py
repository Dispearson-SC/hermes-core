...
from hermes_core.tools.mcp_tool_common import _core, _parse_boolish
from hermes_core.tools import mcp_tool_config as _config
from hermes_core.tools import mcp_tool_errors as _errors
...
from hermes_core.tools.mcp_tool_schema import MCP_TOOL_NAME_PREFIX
...
def _register_lazy_from_cache(new_servers: Dict[str, dict]) -> Tuple[Dict[str, dict], int, int]:
    ...
    lazy_server_count = 0
    try:
        from hermes_core.tools.mcp_schema_cache import config_fingerprint, get_cached_entry
...
def _run_discovery_pass(new_servers: Dict[str, dict]) -> None:
    ...
    from hermes_core.tools.interrupt import is_interrupted as _is_interrupted, set_interrupt as _set_interrupt
