...
from hermes_core.tools.budget_config import DEFAULT_PREVIEW_SIZE_CHARS, BudgetConfig, DEFAULT_BUDGET
...
def _is_host_side_env(env) -> bool:
    ...
    if env is None:
        return True
    try:
        from hermes_core.tools.environments.local import LocalEnvironment
...
def _sandbox_visible_spillover_path(host_path: str, env) -> str | None:
    ...
    try:
        from hermes_core.tools.credential_files import to_agent_visible_cache_path
