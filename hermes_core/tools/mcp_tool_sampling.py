...
from hermes_core.tools.mcp_tool_common import _MISSING, _exc_str, _safe_numeric, _sanitize_error, mcp_field, _core
from hermes_core.tools.mcp_tool_schema import _normalize_mcp_input_schema
...
class SamplingHandler:
    ...
    def _build_llm_call(self, params, resolved_model: str) -> Callable[[], object]:
        ...
        from hermes_core.seams.auxiliary_client import call_llm
