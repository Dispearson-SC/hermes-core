...
def get_env_value(name: str, default=None):
    ...
    """
    try:
        from hermes_core.seams.config import get_env_value as _hermes_get_env_value
    except ImportError:
...
def hermes_xai_user_agent() -> str:
    ...
    try:
        from hermes_core.runtime import __version__
    except Exception:
        __version__ = "unknown"
...
def _resolve_explicit_xai_api_key() -> str:
    ...
    """
    from hermes_core.tools.tool_backend_helpers import resolve_provider_secret
...
def resolve_xai_http_credentials(
    *, force_refresh: bool = False, api_key_hint: Optional[str] = None, prefer_api_key: bool = False,
    ...
    """
    import hermes_core.runtime.auth as auth_mod
