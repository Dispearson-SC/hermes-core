...
from hermes_core.tools.mcp_tool_errors import NonMcpEndpointError, _apply_identity_header, _handshake_rejected_as_modern, _make_redirect_header_stripper, _resolve_client_cert
from hermes_core.tools.mcp_tool_lifecycle import _filter_mcp_children, _orphan_stdio_pid_servers, _orphan_stdio_pids, _stdio_pgids, _stdio_pids
from hermes_core.tools.mcp_tool_common import _core
from hermes_core.tools import mcp_tool_config as _config
from hermes_core.tools import mcp_tool_lifecycle as _lifecycle
from hermes_core.tools import mcp_tool_registration as _registration
...
class MCPServerTransportMixin:
    ...
    def _track_spawned_children(self, new_pids: Set[int]) -> None:
        ...
        for _pid in new_pids:
            try:
                from hermes_core.runtime.process_identity import register_child
