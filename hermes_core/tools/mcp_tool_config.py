...
from hermes_core.tools.mcp_tool_common import _env_ref_name, _prepend_path
...
def _workspace_folder() -> str:
    ...
    try:
        from hermes_core.tools.file_tools_paths import _authoritative_workspace_root
...
def _build_safe_env(user_env: Optional[dict]) -> dict:
    ...
    try:
        from hermes_core.runtime.env_loader import get_secret_source
...
def _load_mcp_config() -> Dict[str, dict]:
    ...
    try:
        ...
        from hermes_core.utils import env_var_enabled as _env_enabled
