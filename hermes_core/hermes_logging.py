...
from hermes_core.seams.paths import get_config_path, get_hermes_home, mkdir_under_hermes_home
...
def setup_logging(
    *,
    ...
    from hermes_core.agent.redact import RedactingFormatter  # lazy: circular at module load
...
def setup_verbose_logging() -> None:
    ...
    from hermes_core.agent.redact import RedactingFormatter
...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def __init__(self, *args, **kwargs):
        from hermes_core.seams.config import is_managed
...
def _read_logging_config():
    ...
    try:
        ...
        try:
            from hermes_core.seams.config import read_raw_config as _rrc
            cfg = _rrc() or {}
        except Exception:
            from hermes_core.utils import fast_safe_load
